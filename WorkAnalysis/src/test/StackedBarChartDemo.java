...
public class StackedBarChartDemo extends ApplicationFrame {
 ...
 public StackedBarChartDemo(String title) {
  ...
  try {
   ...
   ChartObject chartObject1 = new ChartObject(0.95, 0,
     "Kirkalo-bramka");
   ChartObject chartObject2 = new ChartObject(0.234, 0.234,
     "Kirkalo-rejestr");
   ChartObject chartObject3 = new ChartObject(0.234, 0.234,
     "Kirkalo-teor");
   ChartObject chartObject4 = new ChartObject(0.456, 0,
     "Lipski-bramka");
   ChartObject chartObject5 = new ChartObject(0.456, 0.456,
	 "Lipski-rejestr");
   ChartObject chartObject6 = new ChartObject(0.456, 0.456,
	 "Lipski-teor");
 ...
 private CategoryDataset createDataset(List<ChartObject> chartObjectList) {
  ...
  RowKey[] operations = 
   new RowKey[2];
  operations[0] = new RowKey("Operacja1");
  operations[1] = new RowKey("Przerwa");
