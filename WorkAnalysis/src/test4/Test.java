...
public class Test {
    ...
    private IntervalCategoryDataset createDataset() {
        ...
        Task t2 = new Task("Kirkalo teor", date(8), date(18));
        t2.addSubtask(new Task("bar 4", date(10), date(11)));
        t2.addSubtask(new Task("bar 5", date(13), date(15)));
        t2.addSubtask(new Task("bar 6", date(16), date(18)));
        empoyeeHours.add(t2);
