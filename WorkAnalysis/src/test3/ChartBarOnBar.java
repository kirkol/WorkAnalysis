 ...
 *
 */
public class ChartBarOnBar extends ApplicationFrame {
     ...
     */
    public ChartBarOnBar(final String title) {
  ...
  //      plot.getDomainAxis().setMaxCategoryLabelWidthRatio(10.0f);
    ...
    public static void main(final String[] args) {
        ...
        final ChartBarOnBar demo = new ChartBarOnBar("Gantt Chart Demo 2");
        demo.pack();
