 ...
 * Contributor(s):   -;
 *
 * $Id: ChartBarByBar.java,v 1.12 2004/04/26 19:11:54 taqua Exp $
 *
 * Changes
 * -------
 * 06-Jun-2002 : Version 1 (DG);
 * 10-Oct-2002 : Modified to use DemoDatasetFactory (DG);
 * 10-Jan-2003 : Renamed GanttDemo --> ChartBarByBar (DG);
 ...
 *
 */
public class ChartBarByBar extends ApplicationFrame {
     ...
     */
    public ChartBarByBar(final String title) {
...
//        chart.getCategoryPlot().getDomainAxis().setMaxCategoryLabelWidthRatio(10.0f);
    ...
    public static void main(final String[] args) {
        ...
        final ChartBarByBar demo = new ChartBarByBar("Gantt Chart Demo 1");
        demo.pack();
