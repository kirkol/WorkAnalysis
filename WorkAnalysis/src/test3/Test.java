...
public class Test {
    ...
    private IntervalCategoryDataset createDataset() {
        ...
        TaskSeries empoyeeHours = new TaskSeries("godziny bramka");

        Task t1 = new Task("Kirkalo bramka", date(8), date(18));
        t1.addSubtask(new Task("bar 1", date(10), date(11)));
        t1.addSubtask(new Task("bar 2", date(13), date(15)));
        t1.addSubtask(new Task("bar 3", date(16), date(18)));
        empoyeeHours.add(t1);
        
        Task t3 = new Task("Kirkalo teor", date(8), date(18));
        t3.addSubtask(new Task("bar 4", date(10), date(11)));
        t3.addSubtask(new Task("bar 5", date(13), date(15)));
        t3.addSubtask(new Task("bar 6", date(16), date(18)));
        empoyeeHours.add(t3);
        
        dataset.add(empoyeeHours);
        return dataset;
    }
